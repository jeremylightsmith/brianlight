...
<div class="container">
  ...
  <div class="row">
    ...
    <div class="col-sm-4 col-lg-3">
      <a href="/projects/deck" data-target="#simple-modal" data-toggle="modal">
        <div class="thumbnail">
    ...
    <!-- shower job -->
    <div class="col-sm-4 col-lg-3">
      <a href="/projects/shower_job" data-target="#simple-modal" data-toggle="modal">
        <div class="thumbnail">
    ...
    <div class="col-sm-4 col-lg-3">
      <a href="/projects/farmhouse_into_an_office" data-target="#simple-modal" data-toggle="modal">
        <div class="thumbnail">
    ...
    <div class="col-sm-4 col-lg-3">
      <a href="/projects/kitchen_bath_remodel_on_a_shoestring_budget" data-target="#simple-modal" data-toggle="modal">
        <div class="thumbnail">
    ...
    <!-- tile work -->
    <div class="col-sm-4 col-lg-3">
      <a href="/projects/tile_work" data-target="#simple-modal" data-toggle="modal">
        <div class="thumbnail">
    ...
    <!-- basement daycare -->
    <div class="col-sm-4 col-lg-3">
      <a href="/projects/basement_daycare" data-target="#simple-modal" data-toggle="modal">
        <div class="thumbnail">
    ...
    <!-- my own home -->
    <div class="col-sm-4 col-lg-3">
      <a href="/projects/my_own_home" data-target="#simple-modal" data-toggle="modal">
        <div class="thumbnail">
